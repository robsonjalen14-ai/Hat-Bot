...
const channelTargetOption = {
  name: "target",
  description: "Which Hat Manifest channel setting to update",
  type: TYPE.STRING,
  required: true,
  choices: [
...
const RAW_COMMANDS = [
  {
    name: "request",
    description: "Submit a Hat Manifest AppID request",
    options: [appIdOption]
  },
  {
    name: "gen",
    description: "Generate a Hat Manifest ZIP for a Steam App ID",
  ...
  {
    name: "website",
    description: "Open the official Hat Manifest website"
  },
  {
    name: "help",
    description: "Show Hat Manifest bot command help"
  },
  {
    name: "botstatus",
    description: "Show Hat Manifest bot health"
  },
  {
    name: "ping",
  ...
  {
    name: "admin",
    description: "Hat Manifest bot administration",
    options: [
      ...
      sub("manifest", "Check whether an AppID exists in Hat Manifest or the external API", [appIdOption]),
      sub("genadd", "Add extra daily generation uses for a user", [userOption, textOption("count", "Number of extra generations to add")])
    ]
  },
  {
    name: "channel",
    description: "Set Hat Manifest bot channels without editing source code",
    options: [
      sub("set", "Set a Hat Manifest channel", [channelTargetOption, channelOption]),
      sub("list", "List configured Hat Manifest channels")
    ]
  },
  {
    name: "setticket",
  ...
  {
    name: "stats",
    description: "View Hat Manifest request and manifest statistics"
  },
  {
    name: "search",
  ...
  {
    name: "refresh",
    description: "Refresh Hat Manifest bot runtime state"
  }
,
  {
    name: "staff",
    ...
    options: [
      sub("role", "Set the staff role", [roleOption]),
      sub("add", "Add a bot admin", [userOption, { name: "reason", description: "Reason for adding", type: 3, required: false }]),
      sub("remove", "Remove a bot admin", [userOption]),
      sub("list", "List bot admins")
    ]
